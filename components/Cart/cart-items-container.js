            ...
            <div className="flex justify-between">
              ...
              <Link href="/checkout">
                <button
                  ...
                  className={`text-white duration-500 bg-brand-orange hover:bg-brand-royal-blue focus:ring-4 focus:text-white font-medium rounded-lg text-sm px-5 py-2.5 text-center mr-2 mb-2 ${

    ...
    const fetchData = async () => {
      try {
        ...
        const apiUrl = isMobile
          ? `${process.env.NEXT_PUBLIC_WORDPRESS_SITE_URL}/wp-json/wp/v2/main-banner-mobile?_fields=meta.image`
          : `${process.env.NEXT_PUBLIC_WORDPRESS_SITE_URL}/wp-json/wp/v2/main-banner?_fields=meta.image`;
